...
netsh interface ipv4 set address "Cisco" static 172.16.3.71 255.255.255.0 172.16.3.70

netsh interface ipv4 set address "Cisco" static 172.16.3.72 255.255.255.0 172.16.3.70
